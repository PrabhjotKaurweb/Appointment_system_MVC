...
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (1, N'Prabhjot Kaur', N'2000-12-16 12:47:00', N'16/b philip street', N'5678943221')
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (2, N'Raju', N'1999-12-19 09:24:00', N'123 road', N'022777555111')
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (3, N'Gagan Singh', N'1985-12-17 09:29:00', N'1/42 nation raod', N'02233445566')
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (4, N'Manan Singh', N'1999-01-03 09:26:00', N'44/good road Papatoetoe', N'00998877665')
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (5, N'Rajdeep singh', N'2000-12-11 09:27:00', N'Gllen ave manukau', N'00987321456')
INSERT INTO [dbo].[Patient_Detail] ([Id], [Name], [DOB], [Address], [Phone]) VALUES (6, N'Suman', N'2001-10-07 09:35:00', N'17 warwic road', N'001100229986')
SET IDENTITY_INSERT [dbo].[Patient_Detail] OFF
SET IDENTITY_INSERT [dbo].[Doctor_Detail] ON
INSERT INTO [dbo].[Doctor_Detail] ([Id], [Name], [Sepicaligation], [Email], [Phone]) VALUES (1, N'Sukhwant', N'deferf', N'gtrhgfh', N'5678943221')
...
INSERT INTO [dbo].[Appointment] ([Id], [ClinicId], [Doctor_DetailID], [Patient_DetailID], [Appointment_date_time]) VALUES (1, 3, 3, 3, N'2021-04-17 08:28:00')
INSERT INTO [dbo].[Appointment] ([Id], [ClinicId], [Doctor_DetailID], [Patient_DetailID], [Appointment_date_time]) VALUES (2, 2, 4, 2, N'2021-04-27 14:31:00')
INSERT INTO [dbo].[Appointment] ([Id], [ClinicId], [Doctor_DetailID], [Patient_DetailID], [Appointment_date_time]) VALUES (3, 1, 5, 4, N'2021-04-08 16:30:00')
INSERT INTO [dbo].[Appointment] ([Id], [ClinicId], [Doctor_DetailID], [Patient_DetailID], [Appointment_date_time]) VALUES (4, 4, 2, 6, N'2021-05-01 08:28:00')
